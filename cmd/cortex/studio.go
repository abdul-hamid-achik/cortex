...
var studioCmd = &cobra.Command{
	...
	Short:   "Live board of all Cortex sessions across every repo",
...
Auto-refreshes. The only mutation is answering a pending decision (keys 1–9).
...
g/G jump · 1–9 answer pending decision · / search · c clear search · a active-only · r refresh · q quit.`,
